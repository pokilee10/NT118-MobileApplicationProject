...
public class Voc8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voc8);
        ...
        DatabaseReference myRef = database.getReference("vocab").child("officeprocedures").child(indexString);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String indexString = Integer.toString(index);
                textNumTu.setText(indexString+"/9");
                DatabaseReference myRef = database.getReference("vocab").child("officeprocedures").child(indexString);
