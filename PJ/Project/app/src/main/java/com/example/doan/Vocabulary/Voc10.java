...
public class Voc10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voc10);
        ...
        DatabaseReference myRef = database.getReference("vocab").child("shopping").child(indexString);
