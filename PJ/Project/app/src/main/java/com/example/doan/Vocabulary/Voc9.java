...
public class Voc9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voc9);
        ...
        DatabaseReference myRef = database.getReference("vocab").child("electronics").child(indexString);
