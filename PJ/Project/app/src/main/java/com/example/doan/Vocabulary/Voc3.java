...
public class Voc3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voc3);
        ...
        DatabaseReference myRef = database.getReference("vocab").child("warranties").child(indexString);
