...
public class Voc4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voc4);
        ...
        DatabaseReference myRef = database.getReference("vocab").child("businessplanning").child(indexString);
