...
public class Voc7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voc7);
        ...
        DatabaseReference myRef = database.getReference("vocab").child("officetechnology").child(indexString);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String indexString = Integer.toString(index);
                textNumTu.setText(indexString+"/11");
                DatabaseReference myRef = database.getReference("vocab").child("officetechnology").child(indexString);
