...
public class Voc5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voc5);
        ...
        DatabaseReference myRef = database.getReference("vocab").child("conferences").child(indexString);
